/**
 * 知乎创作全量同步的核心逻辑(纯 ESM,由 API 路由与 scripts/sync-zhihu.mjs 共用)。
 *
 * 说明: 故意用 .mjs 而非 .ts,以便被 scripts/sync-zhihu.mjs 直接 import;
 * TypeScript 侧类型见同目录 zhihu-sync.ts(对 .mjs 的手写类型壳)。
 *
 * 产物:
 *   - src/content/posts/zhihu-*.md   文章(article)与回答(answer)全部写入
 *   - src/content/pins.json          想法(pin)全部写入,首页只展示最新 8 条
 */
